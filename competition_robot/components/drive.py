...
class Drive:
    ...
    def drive(self, x, y, turnRate, absoluteAngle):
        ...
        # if robot is turning
            ...
            self._robotDrive.mecanumDrive_Cartesian(x, y, turnRate, self.getAngle() if absoluteAngle else 0)
        # Otherwise keep the robot straight with the pid controller
            ...
            self._robotDrive.mecanumDrive_Cartesian(x, y, self._gyroPid.getTurnRate(), self.getAngle() if absoluteAngle else 0)
